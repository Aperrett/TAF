...
Gem::Specification.new do |taf|
  ...
  taf.add_development_dependency 'logger', '~> 1.2', '>= 1.2.7'
  taf.add_development_dependency 'net-ping', '~> 2.0', '>= 2.0.5'
  taf.add_development_dependency 'nokogiri', '~> 1.8', '>= 1.8.5'
  taf.add_development_dependency 'rubygems-update', '~> 2.7', '>= 2.7.8'
  taf.add_development_dependency 'rubyXL', '~> 3.3', '>= 3.3.31'
  taf.add_development_dependency 'selenium-webdriver', '~> 3.14', '>= 3.141.0'
  taf.add_development_dependency 'time_difference', '~> 0.7', '>= 0.7.0'
  taf.add_development_dependency 'watir', '~> 6.14', '>= 6.15.1'
end
