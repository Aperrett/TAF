...
Gem::Specification.new do |taf|
  ...
  taf.add_development_dependency 'bundler-audit', '~> 0.6'
  taf.add_development_dependency 'colored', '~> 1.2'
  taf.add_development_dependency 'logger', '~> 1.2'
  taf.add_development_dependency 'net-ping', '~> 2.0'
  taf.add_development_dependency 'nokogiri', '~> 1.8'
  taf.add_development_dependency 'rubygems-update', '~> 2.7'
  taf.add_development_dependency 'rubyXL', '~> 3.3'
  taf.add_development_dependency 'selenium-webdriver', '~> 3.14'
  taf.add_development_dependency 'time_difference', '~> 0.7'
  taf.add_development_dependency 'watir', '~> 6.16'
end
